...
class Kecamatan extends CI_Controller {
	...
	public function simpan()
	{
		if($this->input->post()){
			...
			//tidak boleh kosong
			if($this->input->post('kd_kecamatan')==''){
				$validation[]='Kode Kecamatan Tidak Boleh Kosong';
			} elseif (!preg_match('/^\d{2}(\.\d{2})*$/', $this->input->post('kd_kecamatan'))) {
				$validation[]='Kode Kecamatan Harus Berupa Angka dengan format yang benar';
			}
