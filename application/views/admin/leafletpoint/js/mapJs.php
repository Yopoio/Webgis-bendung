...
<!-- Make sure you put this AFTER Leaflet's CSS -->
   ...
   <script type="text/javascript">
	...
	var baseLayers = [
		...
		{	
			name: "OpenCycleMap",
			layer: L.tileLayer('https://tile.thunderforest.com/cycle/{z}/{x}/{y}.png?apikey=fd9ed409009a42fca08908c9a83cb28e')
		},
		{
			name: "Outdoors",
			layer: L.tileLayer('https://tile.thunderforest.com/outdoors/{z}/{x}/{y}.png?apikey=fd9ed409009a42fca08908c9a83cb28e')
		},
		{
	...
	for(i=0;i<dataKategorihotspot.length;i++){
		...
		var layer={
			name: data.nm_kategori_bendung,
			icon: iconByImage(data.icon),
			layer: new L.GeoJSON.AJAX(["<?=site_url('admin/api/data/hotspot/point')?>/"+data.id_kategori_bendung],
				{
